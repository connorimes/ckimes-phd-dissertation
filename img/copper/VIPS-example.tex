...
ymin=.75,
ymax=1.25,
legend entries={{\footnotesize $\mathsf{Performance~Requirement}$},{\footnotesize $\mathsf{DVFS}$},{\footnotesize $\mathsf{Conservative~Power~Cap}$}, {\footnotesize $\mathsf{Aggressive~Power~Cap}$}},
