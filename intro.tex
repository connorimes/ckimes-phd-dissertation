...
This dissertation explores two problems in balancing software performance and energy consumption in computing systems: 1) meeting application performance goals while minimizing energy consumption, and 2) running applications as energy-efficiently as possible (maximizing the work to energy consumption ratio).
