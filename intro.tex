...
\item Extrapolates from empirical results to posit that optimizing energy efficiency can improve the throughput of over-provisioned, power-constrained systems by up to 40\%.
\end{itemize}
