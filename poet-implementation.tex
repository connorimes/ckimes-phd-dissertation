...
The \function{poet\_init} function takes as parameters: the performance goal, the window period over which the controller operates (analogous to $\omega$ in \eqnref{poet-work}), the system's configurations, and a reference to the function that applies the given system configurations.
