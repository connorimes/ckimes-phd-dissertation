...
We later developed a simplified profiling interface, aptly called \interface{Simple Heartbeats}, which allows more flexibility in recording application behavior.
